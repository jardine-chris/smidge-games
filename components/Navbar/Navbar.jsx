  ...
  return (
    <nav className="sticky top-0 z-50 h-16 p-2 text-white bg-black border-b-2 border-grurp-800 font-montserrat">
      <div className="relative w-full h-full">
        ...
        <Link href="/">
          <div className="absolute w-20 h-12 py-1 text-center transition duration-200 ease-in-out -translate-x-1/2 -translate-y-1/2 bg-orange-600 border border-orange-600 rounded-md cursor-pointer left-1/2 hover:border-zinc-700 top-1/2 hover:bg-grurp-900">
