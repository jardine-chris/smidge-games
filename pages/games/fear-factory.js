  ...
  return (
    <div>
      ...
      <div>
        ...
        <div className="mx-2 mb-8 overflow-hidden border rounded-md border-grurp-600/70 bg-grurp-700/40 backdrop-blur-sm font-montserrat lg:w-1/2 lg:mx-auto">
          ...
          >
            <defs>
              ...
              <linearGradient id="background" gradientTransform="rotate(90)">
                ...
                <stop offset="90%" stop-color="#88341b" />
              </linearGradient>
            </defs>
            {/* <polygon
            ...
            /> */}
            <polygon
              points="0,0 15,60 33,21 45,70 50,40 55,53 72,20 85,50 100,10 100,100 100,100 0,100"
              fill="url('#foreground')"
            />
          </svg>
      ...
      <div className="px-2 pt-12 bg-black">
        <section className="grid grid-cols-1 px-2 pb-2 gap-y-6 sm:px-8 sm:grid-cols-2 sm:gap-8 lg:grid-cols-3 xl:grid-cols-4">
          <div
